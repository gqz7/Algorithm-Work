...
const daysInMonth = [31,28,31,30,31,30,31,31,30,31,30,31];
    ...
    function next_day() {
        ...
        console.log(daysInMonth[parseInt(mm)-1], currentDate);
        
       
        if (parseInt(dd) + 1 > daysInMonth[parseInt(mm)-1] && mm < 12) {
            mm = "0" + (parseInt(mm) + 1);
            dd = "01";
        } else if (parseInt(dd) + 1 > daysInMonth[parseInt(mm)-1] && mm == 12) {
            // today = (parseInt(yyyy) + 1) + '-' + 01 + '-' + '01';
            yyyy = (parseInt(yyyy) + 1);
            mm = '01';
            dd = '01';
        } else if (parseInt(dd) + 1 < daysInMonth[parseInt(mm)-1]) {
