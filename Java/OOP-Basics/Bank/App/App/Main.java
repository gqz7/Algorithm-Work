...
//        System.out.println(myCD);
        var mySavings = new SavingsAccount("Tim", 10);

        DebitCard myDebit = new DebitCard("2345");
        myDebit.addAtmAccounts(myCD);
        myDebit.addAtmAccounts(mySavings);

        myDebit.displayAccounts();
    }
}
